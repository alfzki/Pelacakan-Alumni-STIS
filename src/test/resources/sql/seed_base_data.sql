INSERT INTO users (id, username, email, password, full_name, nim, angkatan, program_studi, tahun_lulus, phone_number, alamat, status, role, created_at, updated_at)
VALUES
    (1, 'admin', 'admin@example.com', '$2a$10$I4z0CuHwd8hYIjzx40pjo.8ZsqI1evfTdMq.HkGyu1.I3br46lN4e', 'Test admin', '1000000000001', 62, 'D4', 2024, '081234567891', 'Test Address Admin', 'ACTIVE', 'ADMIN', TIMESTAMP '2024-01-01 00:00:00', TIMESTAMP '2024-01-01 00:00:00'),
    (2, 'user.one', 'user1@example.com', '$2a$10$aisSWk3tLwMNqe2FYFpZferf2.bDpyQc/O0dXVLYKk.F/zo4jNVhC', 'Test user.one', '1000000000002', 62, 'D4', 2024, '081234567892', 'Test Address User One', 'ACTIVE', 'USER', TIMESTAMP '2024-01-01 00:00:00', TIMESTAMP '2024-01-01 00:00:00'),
    (3, 'user.two', 'user2@example.com', '$2a$10$aisSWk3tLwMNqe2FYFpZferf2.bDpyQc/O0dXVLYKk.F/zo4jNVhC', 'Test user.two', '1000000000003', 62, 'D4', 2024, '081234567893', 'Test Address User Two', 'ACTIVE', 'USER', TIMESTAMP '2024-01-01 00:00:00', TIMESTAMP '2024-01-01 00:00:00');
